 ...
 *----------------------------------------------------------------------------*/
/* Do not setup clocks to save code space */
#if (CLOCK_SETUP == -1)
    #define CPU_XTAL_CLK_HZ                 0   /* Value of the external crystal or oscillator clock frequency in Hz */
    #define CPU_INT_SLOW_CLK_HZ             0   /* Value of the slow internal oscillator clock frequency in Hz  */
    #define CPU_INT_FAST_CLK_HZ             0 /* Value of the fast internal oscillator clock frequency in Hz  */
    #define DEFAULT_SYSTEM_CLOCK            0 /* Default System clock value */
#elif (CLOCK_SETUP == 0)
